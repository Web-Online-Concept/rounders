              ...
              <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1}}>
                <div className="content-section" id="inscription" style={{marginBottom: 0}}>
                  <h2 style={{fontSize: '32px', marginBottom: '40px', textAlign: 'center'}}>
                    {t.playOnStake.registration.title}
                  </h2>
...
<div style={{
              ...
              <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1}}>
                <div className="content-section" id="plateforme">
                  <h2 style={{fontSize: '32px', marginBottom: '50px', textAlign: 'center'}}>
                    {t.playOnStake.platform.title}
                  </h2>
...
<div style={{
              ...
              <div style={{maxWidth: '1200px', margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1}}>
                <div className="content-section" id="avantages" style={{marginBottom: 0}}>
                  <h2 style={{fontSize: '32px', marginBottom: '50px', textAlign: 'center'}}>
                    {t.playOnStake.advantages.title}
                  </h2>
            ...
            <div className="cta-box" style={{
              ...
              <h3 style={{fontSize: '36px', marginBottom: '20px', color: 'white'}}>
                {t.playOnStake.finalCta.title}
              </h3>
              <p style={{fontSize: '20px', marginBottom: '40px', color: '#cbd5e1', maxWidth: '600px', margin: '0 auto 40px'}}>
                {t.playOnStake.finalCta.description}
              </p>
              <div className="cta-buttons">
                <a 
                  href="https://stake.bet/?c=rounders&offer=rounders" 
                  ...
                  style={{
                    ...
                    borderRadius: '50px',
                    fontWeight: '700',
                    boxShadow: '0 6px 25px rgba(74, 158, 255, 0.3)',
                    transition: 'all 0.3s',
                    display: 'inline-block',
                    textDecoration: 'none',
                    border: 'none'
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 10px 35px rgba(74, 158, 255, 0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 6px 25px rgba(74, 158, 255, 0.3)';
                  }}
                >
            ...
            {/* Résumé final */}
            <div className="summary-section" style={{marginBottom: '60px'}}>
              <h2 style={{fontSize: '28px', marginBottom: '40px'}}>{t.playOnStake.summary.title}</h2>
